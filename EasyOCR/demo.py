...
# 调用接口直接得到结果
result = reader.readtext('/home/user/xiongdengrui/ocr/EasyOCR/examples/news_test_3.jpg')
print(result)
print(" ")
...
json_name = '/home/user/xiongdengrui/ocr/EasyOCR/examples/news_test_3.json'
file = open(file = json_name, mode = "a+", encoding = "utf-8")
